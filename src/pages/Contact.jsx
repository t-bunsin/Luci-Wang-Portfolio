...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: <Mail className="w-5 h-5" />, label: 'Email', value: 'tbunsin002@gmail.com', link: 'mailto:tbunsin002@gmail.com' },
    { icon: <Phone className="w-5 h-5" />, label: 'Phone', value: '+ (855) 962711117', link: 'tel:+ (855) 962711117' },
  ...
  const socialLinks = [
    ...
    { icon: <MessageCircle className="w-5 h-5" />, label: 'WhatsApp', link: 'https://wa.me/+ (855) 962711117' },
  ]
