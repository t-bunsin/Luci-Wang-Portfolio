      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">Luci Wang</span>
            </Link>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="mailto:tbunsin002@gmail.com"
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Email Luci Wang"
                >
                  <Mail className="w-4 h-4" aria-hidden="true" />
                  tbunsin002@gmail.com
                </a>
              </li>
              <li>
                <a
                  href="tel:+ (855) 962711117"
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Call Luci Wang"
                >
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {currentYear} Luci Wang. All rights reserved.
            </p>
